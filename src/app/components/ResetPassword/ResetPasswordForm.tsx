...
export const ResetPasswordForm = () => {
    ...
    if (
      ...
      try {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_BACKEND_DEPLOYED_URL}/auth/reset/reset-password`,
          {
            method: "POST",
  ...
  useEffect(() => {
    const checkToken = async () => {
      ...
      try {
        const response = await fetch(
          `${process.env.REACT_APP_BACKEND_DEPLOYED_URL}/auth/reset/${token}`,
          {
            method: "GET",
          }
        );
  ...
  useEffect(() => {
    const checkUserId = async () => {
      ...
      try {
        const response = await fetch(
          `${process.env.REACT_APP_BACKEND_DEPLOYED_URL}/auth/reset/auth/${userId}`,
          {
            method: "GET",
            credentials: "include",
          }
